...
function Lead_ResetPassword() {
    ...
    const verifyPassword = async(data)=>{
        try{
            const verifyData = await axios.put(`${Url}/Lead/ResetPassword/${id}/${pin}/${token}`,data,{
                headers:{
  ...
  return (
    <div className='MainParent'>
        <div className='LoginCont'>
            ...
            <Link to="/Lead/">{" "}Login!!</Link>
        </div>
    </div>
  )
}

export default Lead_ResetPassword;