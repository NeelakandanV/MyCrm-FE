...
function ManagerEdit() {
    ...
    const EmplView = manager.filter((ele)=>ele._id==id)
    ...
    const verifySignup = async(data)=>{
        try{
            const verifyData = await axios.put(`${Url}/manager/update/${id}`,data,{
                headers:{
  ...
  return (
    <BaseApp PageTitle="Update Details">
        <div className="Backbtn">
            <Button onClick={()=>navigate("/manager")}>⬅️Back to Manager data</Button>
        </div>
